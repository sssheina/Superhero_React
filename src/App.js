...
const heroes = [
  {
  name: "Чудо-женщина",
  image: "./src/components/images/wonder-woman.jpg",
  universe: "DC Comics",
  ...
  {
  name: "Черная вдова",
  image: "./components/images/black.jpg",
  ...
  {
  name: "Супермен",
  image: "./components/images/super-man.jpg",
  universe: "DC Comics",
  alterego: "Кларк Кент",
  ...
  image: "./components/images/iron-man.jpg",
  universe: "Marvel Comics",
  alterego: "Тони Старк",
  ...
  image: "./components/images/spider-man.jpg",
  universe: "Marvel Comics",
...
{
  name: "Бэтмен",
  image: "./components/images/batman.jpg",
  universe: "DC Comics",
  alterego: "Брюс Уэйн",
...
function App() {
  return (
    <div className="App">
      {
        heroes.map((hero) =>
        <Hero name={hero.name} image={hero.image} universe={hero.universe} alterego={hero.alterego} business={hero.business} friends={hero.friends} superpowers={hero.superpowers} details={hero.details} id={hero.id} />)
      }
    </div>
  );
}
